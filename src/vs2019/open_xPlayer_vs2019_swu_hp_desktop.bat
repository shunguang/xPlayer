...
set PROJ_SRC=E:\swu\projects\xPlayer\src
set PROJ_BUILD=E:\swu\projects\xPlayer\build-vs2019-x64\int
set PROJ_EXPORT=E:\swu\projects\xPlayer\build-vs2019-x64\bin

"C:\Program Files (x86)\Microsoft Visual Studio\2019\Community\Common7\IDE\devenv.exe" %PROJ_SRC%\vs2019\xPlayer.sln
