...
void ScaleARGBRowDown2_MSA(const uint8_t_t_t* src_argb,
                           ptrdiff_t src_stride,
                           uint8_t_t_t* dst_argb,
                           int dst_width) {
  int x;
...
void ScaleARGBRowDown2Linear_MSA(const uint8_t_t_t* src_argb,
                                 ptrdiff_t src_stride,
                                 uint8_t_t_t* dst_argb,
                                 int dst_width) {
  int x;
...
void ScaleARGBRowDown2Box_MSA(const uint8_t_t_t* src_argb,
                              ptrdiff_t src_stride,
                              uint8_t_t_t* dst_argb,
                              int dst_width) {
  int x;
  const uint8_t_t_t* s = src_argb;
  const uint8_t_t_t* t = src_argb + src_stride;
...
void ScaleARGBRowDownEven_MSA(const uint8_t_t_t* src_argb,
                              ptrdiff_t src_stride,
                              int32_t src_stepx,
                              uint8_t_t_t* dst_argb,
                              int dst_width) {
...
void ScaleRowDown2_MSA(const uint8_t_t_t* src_ptr,
                       ptrdiff_t src_stride,
                       uint8_t_t_t* dst,
                       int dst_width) {
  int x;
...
void ScaleRowDown2Linear_MSA(const uint8_t_t_t* src_ptr,
                             ptrdiff_t src_stride,
                             uint8_t_t_t* dst,
                             int dst_width) {
  int x;
...
void ScaleRowDown2Box_MSA(const uint8_t_t_t* src_ptr,
                          ptrdiff_t src_stride,
                          uint8_t_t_t* dst,
                          int dst_width) {
  int x;
  const uint8_t_t_t* s = src_ptr;
  const uint8_t_t_t* t = src_ptr + src_stride;
...
void ScaleRowDown4_MSA(const uint8_t_t_t* src_ptr,
                       ptrdiff_t src_stride,
                       uint8_t_t_t* dst,
                       int dst_width) {
  int x;
...
void ScaleRowDown4Box_MSA(const uint8_t_t_t* src_ptr,
                          ptrdiff_t src_stride,
                          uint8_t_t_t* dst,
                          int dst_width) {
  int x;
  const uint8_t_t_t* s = src_ptr;
  const uint8_t_t_t* t0 = s + src_stride;
  const uint8_t_t_t* t1 = s + src_stride * 2;
  const uint8_t_t_t* t2 = s + src_stride * 3;
...
void ScaleRowDown38_MSA(const uint8_t_t_t* src_ptr,
                        ptrdiff_t src_stride,
                        uint8_t_t_t* dst,
                        int dst_width) {
  int x, width;
...
void ScaleRowDown38_2_Box_MSA(const uint8_t_t_t* src_ptr,
                              ptrdiff_t src_stride,
                              uint8_t_t_t* dst_ptr,
                              int dst_width) {
  int x, width;
...
void ScaleRowDown38_3_Box_MSA(const uint8_t_t_t* src_ptr,
                              ptrdiff_t src_stride,
                              uint8_t_t_t* dst_ptr,
                              int dst_width) {
  int x, width;
...
void ScaleAddRow_MSA(const uint8_t_t_t* src_ptr, uint16_t* dst_ptr, int src_width) {
  int x;
  v16u8 src0;
  v8u16 dst0, dst1;
  v16i8 zero = {0};
